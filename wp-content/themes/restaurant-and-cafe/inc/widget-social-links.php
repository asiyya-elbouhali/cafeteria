...
class Restaurant_and_Cafe_Social_Links extends WP_Widget {
	...
	public function widget( $args, $instance ) {
        ...
        ?>
            <ul class="social-networks">
                ...
                <?php }  if( $tiktok ){ ?>
                <li><a href="<?php echo esc_url( $tiktok ); ?>" title="<?php esc_attr_e( 'Tiktok', 'restaurant-and-cafe' ); ?>"><i class="fab fa-tiktok"></i></a></li>
                <?php } ?>
			</ul>
        <?php
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'tiktok' ) ); ?>"><?php esc_html_e( 'Tiktok', 'restaurant-and-cafe' ); ?></label> 
